    ...
    <form action="{{ route('admin.departments.update', $department->id) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="department_code" id="department_code" value="{{ old('department_code', $department->department_code) }}"
            ...
            <div>
                ...
                <input type="text" name="hod_name" id="hod_name" value="{{ old('hod_name', $department->hod_name) }}"
