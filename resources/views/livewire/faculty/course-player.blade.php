                            ...
                            <div class="border-t border-zinc-200 bg-zinc-50/80 p-4 dark:border-zinc-800 dark:bg-zinc-950/70 lg:border-t-0 lg:border-l">
                                <div class="space-y-4">
                                    <div class="rounded-[1.5rem] border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
                                        <p class="text-sm font-semibold text-zinc-950 dark:text-white">Playback Rules</p>
                                        <div class="mt-4 space-y-3 text-sm text-zinc-600 dark:text-zinc-300">
                                            <div class="flex items-start gap-3">
                                                <flux:icon.shield-check class="mt-0.5 h-4 w-4 text-emerald-500" />
                                                <p>Only the furthest legitimately watched point can be revisited. Jumping past it snaps back.</p>
                                            </div>
                                            <div class="flex items-start gap-3">
                                                <flux:icon.chart-bar class="mt-0.5 h-4 w-4 text-blue-500" />
                                                <p>Watch at least {{ $currentModule->watchRequirementPercent }}% of this lesson to unlock the module quiz.</p>
                                            </div>
                                            <div class="flex items-start gap-3">
                                                <flux:icon.arrow-uturn-left class="mt-0.5 h-4 w-4 text-amber-500" />
                                                <p>Rewinding is always allowed. Forward controls appear only when free seek is enabled.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="rounded-[1.5rem] border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
                                        <div class="flex items-center justify-between gap-3">
                                            <div>
                                                <p class="text-sm font-semibold text-zinc-950 dark:text-white">Quiz Gate</p>
                                                <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">The module quiz only opens after the watch requirement is met.</p>
                                            </div>
                                            <div class="text-right">
                                                <p class="text-2xl font-semibold text-zinc-950 dark:text-white" x-text="watchPercent + '%'"></p>
                                                <p class="text-xs text-zinc-500 dark:text-zinc-400">watched</p>
                                            </div>
                                        </div>

                                        <div class="mt-4 h-2 rounded-full bg-zinc-200 dark:bg-zinc-800">
                                            <div class="h-2 rounded-full bg-gradient-to-r from-blue-500 to-emerald-500 transition-all duration-300" :style="`width: ${Math.min(watchPercent, 100)}%`"></div>
                                        </div>

                                        <div class="mt-4 space-y-3">
                                            <div class="rounded-2xl border px-4 py-3 text-sm" :class="watchUnlocked || isCompleted ? 'border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-900/60 dark:bg-emerald-900/20 dark:text-emerald-300' : 'border-zinc-200 bg-zinc-50 text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950/70 dark:text-zinc-300'">
                                                <span x-text="watchUnlocked || isCompleted ? 'Watch requirement met. You can continue to the quiz.' : `Watch at least ${watchRequirementPercent}% to unlock the quiz.`"></span>
                                            </div>
